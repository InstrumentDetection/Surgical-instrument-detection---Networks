...
CHOSEN_MODEL = "COCO-Detection/faster_rcnn_R_101_FPN_3x.yaml"
...
def visualize_detection(cfg):
    ...
    cfg.MODEL.WEIGHTS = os.path.join(cfg.OUTPUT_DIR, "model_0014999.pth")  # path to the model we just trained
    ...
    test_images_path = data_path+"ULTIMATE_FINAL_DATA/FINAL_TEST_SET_UNTOUCHED"
...
def setup(args):
    ...
    cfg.OUTPUT_DIR = "./output/faster_101_FPN_3x/11mar/"
    #THIS MUST BE UPDATED
    #<<<<
    #<<<<
...
#python3 faster_rcnn.py --num-gpus 1 --config-file ./output/config.yaml --eval-only true